...
const Newsletter = () => {
  ...
  return (
    <section id="newsletter" className="py-20 bg-gradient-to-br from-black to-gray-900 text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl font-black leading-tight">
                Become <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">Ma se Kind</span>
              </h2>
              
              <p className="text-xl text-gray-300 leading-relaxed">
                Join our family of over 1,000 proud South Africans. Get exclusive access to new drops, 
                cultural stories, and community events.
              </p>
            </div>
            ...
            <div className="bg-white bg-opacity-10 rounded-2xl p-8 backdrop-blur-sm border border-white border-opacity-20">
              ...
              {!isSubscribed ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-300">Check your email for your welcome gift.</p>
                </div>
              )}
            ...
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700">
              ...
              <p className="text-gray-300 mb-4">
                Represent MSK in your community. Earn commissions, get free gear, and help spread the Ma se Kind message.
              </p>
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-center mb-8">Member Benefits</h3>
            
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start space-x-4 p-6 bg-white bg-opacity-5 rounded-xl backdrop-blur-sm border border-white border-opacity-10 hover:bg-opacity-10 transition-all duration-300">
            ...
            <div className="bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm text-center">
              <div className="flex items-center justify-center space-x-2 mb-3">
                <div className="flex -space-x-2">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="w-8 h-8 bg-gray-400 rounded-full border-2 border-white flex items-center justify-center text-xs font-bold">
              ...
              <p className="text-gray-400 text-sm">Join the fastest-growing SA streetwear community</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl p-6 border border-gray-700">
              ...
              <blockquote className="text-white mb-3 italic">
                "Being part of the MSK family means everything. The exclusive drops, the community events, 
                the cultural pride - it's more than just a newsletter."
              </blockquote>
