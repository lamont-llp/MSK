      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Real people, real stories, real pride. See how MSK Productions brings communities together 
            through authentic South African streetwear.
          </p>
        </div>

        {/* Customer Testimonials */}
        <div className="mb-20">
          <h3 className="text-2xl font-bold text-black mb-8 text-center">What Our Family Says</h3>
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">Purchased: {testimonial.product}</span>
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-black mb-2">Follow the Movement</h3>
            <p className="text-gray-600">See how our community rocks MSK gear</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {socialPosts.map((post) => (
              <div key={post.id} className="group bg-black rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
        ...
        <div className="text-center mt-16 bg-gray-50 rounded-2xl p-12">
          <h3 className="text-2xl font-bold text-black mb-4">Share Your MSK Story</h3>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Tag us @mskproductions and use #MaSeKind to be featured in our community spotlight. 
            Show the world what it means to be part of the family.
          </p>
